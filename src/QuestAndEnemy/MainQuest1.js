export const MQ1 = {
    Clue1 : {
        ...
        + "\n Some say he is just an eccentric healer, others believe he has sinister secrets."
    ...
    Clue2 : {
        ...
        + "\n daring the wrath of deep-dweller-monsters. Alas, woe befell them! Four days passed, but only one of them emerged. "
    ...
    Clue3 : {
        ...
        + "\n Their fear of war, their yearning for peace has made them soft, made them blind."
        + "\n The truth, however, is there for those willing to see. The King's patrols have come upon Untari filth hiding in ",
        GoodText2: "hidden fortifications.",
        BadText3: "\n Whether slavers, spies, or cutthroats looking for easy pickings, avoid them like the plague!"
    }
}